...
# When launched as `python main.py`, Python puts this file's directory on
# sys.path, so `src...` imports resolve regardless of the working directory
# the MCP client happens to spawn us from.
